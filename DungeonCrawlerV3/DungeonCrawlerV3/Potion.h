...
public:
	LifeStealPotion(const char* name, int value) : Item(name, value, (int)GameStateMask::Combat) {}
...
public:
	RegenPotion(const char* name, int value) : Item(name, value, (int)GameStateMask::Combat) {}
...
public:
	HealPotion(const char* name, int value) : Item(name, value, (int)GameStateMask::Combat + (int)GameStateMask::Normal) {}
